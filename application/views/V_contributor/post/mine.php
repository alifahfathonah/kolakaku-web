                                    ...
                                    <tr>
                                        ...
                                        <?php foreach ($table_header as $kh => $vh): ?>
                                            <?php 
                                                if($kh=='level') 
                                                    if ($value->{$kh}==1) {
                                                        $value->{$kh} = '<span class="label label-success"> Diterima </span>';
                                                    }
                                                    else if ($value->{$kh}==2) {
                                                        $value->{$kh} = '<span class="label label-danger"> Ditolak </span>';
                                                    }
                                                    else {
                                                        $value->{$kh} = '<span class="label label-info"> Diproses </span>';
                                                    }
                                            ?>
